...
//           const publicationDate = parseDate(news.publishedAt);
              ...
              {error ? (
                  ...
                  <ul>
                      {filteredArticles.map((article, index) => (
                          <li key={index} className="noticia-item">
                              <img
                                  src={article.image || article.urlToImage} // Ajusta esto según cómo se llame la propiedad de la imagen
                                  alt={article.title || 'Imagen relacionada con la noticia'}
                                  title={article.title || 'Imagen relacionada con la noticia'}
